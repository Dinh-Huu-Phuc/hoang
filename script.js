//Thôi tao xóa rồi sài code thì nhớ ghi nguồn tao vô nhé
...
var geomLight = new THREE.CylinderBufferGeometry(0.25, 0.25, 0.05, 20);
...
for (let i = 0; i < num; i++){
  instPos.push( Math.random() - 0.5, Math.random() - 1, Math.random() - 0.5 );
